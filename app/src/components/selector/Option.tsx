...
export function Option({ name, value, selected, onChange }: Props) {
  ...
  return (
    <div className="relative">
      <input id={inputId} name={name} type="radio" checked={selected} onChange={onChange} className="peer absolute opacity-0" />
      <label
        htmlFor={inputId}
        className={clsx(
          ...
          {
            'bg-neutral-300 hover:bg-neutral-400 peer-focus-visible:ring-neutral-400': !selected,
